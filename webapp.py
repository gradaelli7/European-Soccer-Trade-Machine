...
def main():
    ...
    with colB:
        ...
        st.markdown("- **Specify Player Positions and Traits (Optional):** Tailor your search further by specifying player positions and traits that align with your team's needs and strategic objectives. You can input up to five position-player trait pairings to refine your transfer targets. IMPORTANT: If you do not specify player positions or leave the Position dropdown as 'Select Position', you will be provided with transfer recommendations based on current position weaknesses determined by our algorithm.")
